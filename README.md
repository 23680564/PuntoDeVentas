...
<img width="1257" height="700" alt="image" src="https://github.com/user-attachments/assets/22d72980-50ce-43fa-ab5f-15d97f81f8e6" />


## Pestaña de gastos

<img width="1266" height="713" alt="image" src="https://github.com/user-attachments/assets/03548332-7b2c-425e-b9f8-cc92cbfd6c5e" />


## Pestaña de dashboard

<img width="1263" height="708" alt="image" src="https://github.com/user-attachments/assets/fa497bf1-ac74-4db9-a95e-349b13ed16a0" />

## Pestaña de historial de gastos 

<img width="1263" height="708" alt="image" src="https://github.com/user-attachments/assets/deda6923-b7d8-495c-8778-6b78b10c8566" />

## Pestaña de cerrar dia 

<img width="1262" height="712" alt="image" src="https://github.com/user-attachments/assets/430adf03-a4ee-47c8-9850-4b3029f266e0" />

# Para concluir con la correccion de Errores o BUGS 

Durante el desarrollo del sistema en Flet se detectaron y corrigieron distintos errores que impactaban tanto la lógica interna, como la presentación de la información y el comportamiento de la interfaz.

En primer lugar, se ajustaron errores lógicos, como el cálculo de la ganancia, ya que inicialmente se estaban utilizando los valores de ventas y gastos en el orden incorrecto. Asimismo, se resolvieron inconvenientes en el manejo de datos, garantizando que los valores numéricos, como los montos, se almacenen utilizando tipos adecuados (float), evitando así inconsistencias en operaciones posteriores.

Por otra parte, se realizaron mejoras en la visualización, incluyendo el ajuste proporcional de los gráficos de barras y el formateo adecuado de estructuras de datos más complejas, como los productos vendidos. Esto permitió que la información se muestre de forma más clara y comprensible para el usuario.

Adicionalmente, se corrigieron problemas relacionados con la programación orientada a objetos y el uso del framework, principalmente en el manejo correcto de atributos de instancia (self) y eventos. Estas correcciones ayudaron a prevenir errores en tiempo de ejecución y a mejorar la organización del código.

Finalmente, se optimizó el comportamiento de la interfaz de usuario, asegurando que los cambios se reflejen correctamente mediante actualizaciones explícitas (update()), y que las interacciones, como botones de recarga y notificaciones, funcionen de manera consistente.
